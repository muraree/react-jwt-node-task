          ...
          <div className="col-md-10 col-md-offset-1">
            <div className="panel panel-default panel-table">
              ...
              <div className="panel-body">
                {  showListUsers && <UsersList {...this.props} users={this.props.users} filterUser={this.props.filterUser} listUser={this.props.listUser} users={this.state.pageUsers} handleDelete={this.handleDelete} handleEdit={this.handleEdit} /> }
                {  this.state.showCreateNewUser && <UserDetailsForm createUser createNewUser={this.props.createNewUser}/> }
